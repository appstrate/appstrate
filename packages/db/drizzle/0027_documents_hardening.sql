ALTER TABLE "runs" ADD COLUMN "artifacts" jsonb;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_storage_deletion_jobs_pending" ON "storage_deletion_jobs" USING btree ("bucket","storage_key") WHERE "storage_deletion_jobs"."completed_at" IS NULL;--> statement-breakpoint
ALTER TABLE "organizations" ADD COLUMN "documents_bytes_limit" bigint;--> statement-breakpoint
