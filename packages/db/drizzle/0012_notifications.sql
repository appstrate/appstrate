...
CREATE UNIQUE INDEX "uq_notifications_run_end_user_type" ON "notifications" USING btree ("run_id","end_user_id","type") WHERE "notifications"."end_user_id" IS NOT NULL AND "notifications"."run_id" IS NOT NULL;