...
export default tseslint.config(
  ...
  },
  {
    ...
    ignores: [
      ...
      "apps/web/src/hooks/use-auto-seed-models.ts",
      ...
      "apps/web/src/hooks/use-model-provider-credentials.ts",
      "apps/web/src/hooks/use-model-provider-pairing.ts",
      "apps/web/src/hooks/use-models.ts",
      "apps/web/src/hooks/use-mutations.ts",
      "apps/web/src/hooks/use-notifications.ts",
      "apps/web/src/hooks/use-org-settings.ts",
      ...
      "apps/web/src/pages/onboarding/create-step.tsx",
      "apps/web/src/pages/onboarding/done-step.tsx",
      "apps/web/src/pages/onboarding/members-step.tsx",
      "apps/web/src/pages/org-settings/cli-sessions.tsx",
      "apps/web/src/pages/org-settings/general.tsx",
      "apps/web/src/pages/org-settings/members.tsx",
      "apps/web/src/pages/preferences/devices.tsx",
    ],
    rules: {
      "no-restricted-imports": [
        "error",
