...
| D9  | One installation per destination = the currently synchronized profile context                                                                                                                                                                          | One plugin per profile / org                                    | The marketplace entry is a static string; multi-org users switch with `appstrate org switch` or run `--profile` from cron                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
