...
| `OrgModel`                                                     | `id`, `apiShape`, `providerId`, `modelId` (upstream id, 5c), `credentialId` (5c), `contextWindow`, `maxTokens`, `iconUrl`, `createdAt`, `updatedAt` | `label`, `provider_name`, `base_url`, `generation`, `input`, `reasoning`, `cost`, `enabled`, `is_default`, `needs_reconnection`, `aliased`, `source`, `created_by` |
