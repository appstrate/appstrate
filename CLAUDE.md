...
| ------------------------------------- | -------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `MODULES`                             | No       | `"oidc,webhooks,core-providers"`              | Comma-separated module specifiers to load at boot. Defaults: `oidc` + `webhooks` + `core-providers` (openai/anthropic/openai-compatible API keys). Append `@appstrate/module-codex` (workspace package — ChatGPT OAuth provider) to enable that surface — opt-in due to upstream ToS posture. Claude Pro/Max/Team OAuth lives in the external private `@appstrate/module-claude-code` package (separate repo; install + append `@appstrate/module-claude-code` to enable). Any other external npm specifier works for operator-installed providers. Removing a module is the only way to disable its model providers — there is no finer-grained per-providerId knob. |
