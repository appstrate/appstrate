 ...
 *
 * Boots the shipped `@appstrate/bun-toolkit` system package (a complex,
 * multi-tool, zero-dependency Bun MCP server) through the full
...
const FIXTURE_DIR = path.join(
  import.meta.dir,
  "../../../scripts/system-packages/integration-bun-toolkit-1.0.0",
);
