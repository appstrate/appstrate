...
const PLUGIN_MANIFEST = {
  ...
  description:
    "Skills and agent commands from your Appstrate organization, kept in sync by `appstrate packages sync`.",
};

const PLUGIN_README = `# Appstrate skills

This directory is generated by \`appstrate packages sync\` from the skills
installed in the spaces selected on your Appstrate CLI profile, and from the
agents active in its pinned space.
