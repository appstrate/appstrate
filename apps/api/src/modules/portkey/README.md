...
- **Phase 4c — OTel metrics** — **NOT shipping**. Bundle scan confirms zero OTel / Prometheus surface in 1.15.2 OSS (the metrics export lives in Portkey Cloud). Would require a fork; out of scope.
