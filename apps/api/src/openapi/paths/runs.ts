                    ...
                    },
                    {
                      ...
                      properties: {
                        ...
                        spec: {
                          type: "string",
                          description:
                            "Version, semver range, or dist-tag. Only valid with `source: published`. Resolution falls back to the version installed in the application, then to the `latest` dist-tag.",
                        },
                        integrity: {
                          type: "string",
                          description:
                            "Optional SRI digest (`sha256-…`) the runner received with the bundle download. Surfaces as a debug breadcrumb when the resolved version drifts from the artifact the runner downloaded; not a rejection signal.",
                        },
                        providerProfiles: {
                          type: "object",
                          additionalProperties: { type: "string" },
