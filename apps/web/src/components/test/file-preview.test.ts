 ...
 * `lib/test/files.test.ts`, where the helper now lives.
 */
...
const source = readFileSync(fileURLToPath(new URL("../file-viewer.tsx", import.meta.url)), "utf-8");
...
describe("FileViewer iframe sandbox", () => {
