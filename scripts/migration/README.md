...
| 0022 | not applied         | `integration_connections.account_id` = `'default'` (the old no-identity sentinel) → NULL — **run right after deploying the release carrying drizzle `0071`**                                                                                                                                                                                                                                                                                                                                                                                                                                                              | unmeasured — prints before/after counts, aborts if any row still reads `'default'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
