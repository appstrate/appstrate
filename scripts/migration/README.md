...
`account_id` only. `0026` renames every camelCase top-level key of
...
| 0026 | not applied         | camelCase → snake_case for every top-level key of `integration_connections.identity_claims` (`accountId` → `account_id`, `avatarUrl` → `avatar_url`, …; generic regexp, an existing snake_case twin wins) — **run once after the deploy**                                                                                                                                                                                                                                                                                                                                                                                 | unmeasured — prints the rows to rewrite (and those holding both spellings) before, aborts if any camelCase key survives                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
