...
## Detail — Space-assignment key casing (script `0020`)
...
— so their rows move with it. `0020` renames the key in every array element that
...
## Detail — Identity-less connections (drizzle `0071`, script `0021`)
...
nothing (a `DROP NOT NULL` scans no row, so it licenses no repair). `0021`
...
| 0020 | not applied         | `space_id` → `spaceId` inside `org_invitations.space_assignments` and `oauth_clients.signup_space_assignments` — **run inside the deploy window**                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | unmeasured — prints before/after counts, aborts if any row still carries `space_id`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 0021 | not applied         | `integration_connections.account_id` = `'default'` (the old no-identity sentinel) → NULL — **run right after deploying the release carrying drizzle `0071`**                                                                                                                                                                                                                                                                                                                                                                                                                                                              | unmeasured — prints before/after counts, aborts if any row still reads `'default'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
