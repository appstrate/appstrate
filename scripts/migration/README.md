...
| 0026 | not applied         | `package_id` / `agent_id` → `packageId`, `run_id` → `runId` inside `notifications.payload` — **run inside the deploy window**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | unmeasured — prints before/after counts, aborts if any row still carries a snake key                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
