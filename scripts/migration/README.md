...
## Detail — Dropped-integration run-log key casing (script `0028`)

**Not a runbook.** `run_logs.data` is returned verbatim on the run-log route and
SSE; the `integration_dropped` marker spells its key `integration_id`. `0028`
renames the stored `integrationId` keys. Nothing reads the key back, so run it
...
| 0028 | not applied         | `integrationId` → `integration_id` inside `run_logs.data` of `integration_dropped` rows — **run once after the deploy**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | unmeasured — one sequential scan of `run_logs`; prints before/after counts, aborts if any `integrationId` key survives                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
