...
## Duplicate model bindings (script `0013`, drizzle `0064`)

1. **Pre-flight, before any drizzle migration.** `0064` creates
...
3. Check `duplicate_bindings_after` prints 0 and all four `dangling_*` counts
   ...
   `0064_org_models_unique_binding.sql`.
