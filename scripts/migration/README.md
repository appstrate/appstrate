...
| 0005 | not applied | AFPS `delivery.http.prefix`: bare auth scheme → separator-carrying (`"Bearer"` → `"Bearer "`), both manifest stores | unmeasured — statement rehearsed on a PGlite fixture   |
