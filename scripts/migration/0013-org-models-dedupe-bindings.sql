...
-- `packages/db/drizzle/0064_org_models_unique_binding.sql`, when — and only
-- when — the rollout pre-flight in `README.md` counts a duplicate binding. Not
-- afterwards: letting `0064`'s `CREATE UNIQUE INDEX` raise 23505 rolls the
...
-- after; the "after" count must be 0 for `0064` to succeed.
