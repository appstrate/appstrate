...
- Si aucune méthode ne convient, charge `@appstrate/skill-authoring`. Il consultera au besoin sa
  bibliothèque de références, puis créera une skill adaptée sous le scope de l'organisation avant
  l'agent.

Une assistant skill système et les références qu'elle contient guident l'authoring. Ce ne sont pas
